...
<article class="post">
    ...
    <div class="post-content">
        ...
        <div class="social-share">
            <span class="social-share-title pull-left text-capitalize">By <a href="#"><?= $arResult['AUTHOR'] ?></a> On <?= $arResult['DISPLAY_ACTIVE_FROM'] ?></span>
            <ul class="text-center pull-right">
                <li><a href="#"><i class="fa fa-eye"></i> <?= $arResult['SHOW_COUNTER'] ?></a></li>
